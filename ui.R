                ...
                tabsetPanel( #type = "pills",
                  ...
                  tabPanel("Enrichment analysis", 
                           ...
                           sidebarPanel(id="sidebar",
                                        ...
                                        numericInput("ea_subsetfdr", "P-adj cut-off", value = 0.05, min = 0, max = 1, step = 0.05, width = "45%"),
                                        numericInput("ea_subsetlc", "LogFC cut-off", value = 1, min = 0, max = 3, step = 1, width = "45%"),
                                        tags$hr(),
