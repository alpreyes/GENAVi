...
# default input file
all_cell_lines <- read_csv("ensembleid.csv", col_types = readr::cols(), col_names = TRUE) ##read in data going to view, try changing to all_cell_lines_ordered.csv to see if it breaks everything...no changes
